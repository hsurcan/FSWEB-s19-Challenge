...
public class CommentService {
    ...
    /**
     * POST /comment : bir tweete, kimligi dogrulanmis kullanici adina yorum.
     */
    @Transactional
    ...
    /**
     * PUT /comment/{id} : yalnizca yorumun sahibi guncelleyebilir.
     */
    @Transactional
    ...
    /**
     * DELETE /comment/{id} : yorum sahibi VEYA tweet sahibi silebilir.
     * (Twitter kurali: tweet sahibi, kendi tweetinin altindaki yorumu kaldirabilir.)
     */
    @Transactional
