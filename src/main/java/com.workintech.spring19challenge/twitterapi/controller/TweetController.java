...
public class TweetController {
    ...
    /** POST /tweet — sahibi JWT'den belirlenir, anonim tweet yoktur. */
    @PostMapping
    ...
    /** GET /tweet/findByUserId?userId=1 — kullanicinin tum tweetleri. */
