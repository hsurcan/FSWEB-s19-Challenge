...
/**
 * Ornek semadaki users tablosu: first_name, last_name, email, password
 * + Twitter dogasi geregi benzersiz username.
 * Postgres'te "user" rezerve kelime oldugu icin tablo adi "users".
 */
@Entity
...
public class User {
    ...
    /**
     * Ornek semadaki users_roles kopru tablosu.
     */
